        ...
        <div class="custom-row-2">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="contact-form">
                    ...
                    <form class="contact-form-style"  method="post" action="contact.php">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="submit" name="submit" value="SEND" style="margin:auto;">
                            </div>
                        </div>
                    </form>
...
<?php
    ...
    function add_response($con)
    {
        ...
        $sql="INSERT INTO `responses_tbl`(`Name`, `Email`, `Subject`, `Message`) VALUES ('$name','$email','$subject','$message')";
        $check=mysqli_query($con,$sql);
        if($check)
        {
            echo '<script>alert("Your response has been added");</script>';
        }
        else
        {
